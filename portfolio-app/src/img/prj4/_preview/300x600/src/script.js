...
function init() {
	...
	TweenLite.set(lockup, {alpha:0, x:0, y:230, scale:4});
	...
	//--
	TweenLite.set(txt1a, {alpha:0, x:0, y:disp/1.1});
...
function tween1(){
	...
	TweenLite.to(lockup, 1, {delay:fDelay, alpha:1, x:0, y:0, scale:1, ease:tweenEase});
...
function fnCloudAnim(){
	TweenLite.to(cloud1, 5, {delay:0.0, alpha:1, x:0, y:hFrame*1.3, rotation:0, ease:Linear.easeInOut});
	TweenLite.to(cloud2, 6, {delay:1, alpha:1, x:0, y:hFrame*1.3, rotation:0, ease:Linear.easeInOut});
...
function fnCtaMouseOver(){
	...
	TweenLite.to(btn_shimmer, 0.5, {delay:0, alpha:1, x:175, y:0, ease:Linear.easeInOut, onComplete: fnCtaMouseOut});
}
//
