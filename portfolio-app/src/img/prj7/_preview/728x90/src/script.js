...
function init() {
	...
	TweenLite.set(lockup, {alpha:0, x:0, y:0});
	...
	TweenLite.set(txt1, {alpha:0, scale:4, x:0, y:10});
...
function tween1(){
	...
	TweenLite.to(bground, 3, {delay:0, scale:1, alpha:1, y:-10, x:0, ease:Linear.easeNone, onComplete:tweenEnd});
}
...
function fnMouseMovement(event) {
	...
	TweenLite.to(bground, 1, {delay:0, alpha:1, x:0, y:-mouseY/10, ease:Cubic.easeOut});
	TweenLite.to(txt1a, 1, {delay:0, alpha:1, x:0, y:mouseY/25, ease:Cubic.easeOut});
	TweenLite.to(txt1b, 1, {delay:0, alpha:1, x:0, y:mouseY/25, ease:Cubic.easeOut});
	//TweenLite.to(cta, 1, {delay:0, alpha:1, x:0, y:-mouseY/50, ease:Cubic.easeOut});
}
