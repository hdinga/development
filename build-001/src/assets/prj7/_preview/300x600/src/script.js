...
function init() {
	...
	TweenLite.set(txt1, {alpha:0, scale:4, x:0, y:0});
...
function tween0(){
	...
	TweenLite.to(txt1, 0.8, {delay:0, alpha:1, x:0, y:0, scale:1, ease:tweenEase});
...
function tween1(){
	...
	TweenLite.to(txt1, 0.75, {delay:fDelay, alpha:1, x:0, y:-disp/1.3, ease:Back.easeInOut});
