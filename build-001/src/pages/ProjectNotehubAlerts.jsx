      ...
      <div className="page-content">
        <section className="section-project container">
          ...
          <div className="container">
            <div className="row justify-content-center">
              <figure className="col-9 mt-3 tc-project_content">
                <img className="figure-img img-fluid" src="../src/assets/prj10/prj1.png" alt="Alerts design mockups" />
                <figcaption className="figure-caption">Alerts design mockups</figcaption>
              </figure>
              <figure className="col-9 mt-3 tc-project_content">
                <img className="figure-img img-fluid" src="../src/assets/prj10/prj2.png" alt="Alerts component documentation" />
                <figcaption className="figure-caption">Alerts component documentation</figcaption>
              </figure>
              <figure className="col-9 mt-3 tc-project_content">
                <img className="figure-img img-fluid" src="../src/assets/prj10/prj3.png" alt="System generated Notifications" />
                <figcaption className="figure-caption">System generated Notifications</figcaption>
              </figure>
              
              <figure className="col-9 mt-3 tc-project_content">
                <img className="figure-img img-fluid" src="../src/assets/prj10/prj4.png" alt="Notifications nav dropdown" />
                <figcaption className="figure-caption">Notifications nav dropdown</figcaption>
              </figure>
              <figure className="col-9 mt-3 tc-project_content">
                <img className="figure-img img-fluid" src="../src/assets/prj10/prj5.png" alt="Notifications popup dropdown" />
                <figcaption className="figure-caption">
                  Notifications dashboard</figcaption>
              </figure>
              <figure className="col-9 mt-3 tc-project_content">
                <img className="figure-img img-fluid" src="../src/assets/prj10/prj6.png" alt="Notifications settings" />
                <figcaption className="figure-caption">Notifications settings</figcaption>
              </figure>
              <figure className="col-9 mt-3 tc-project_content">
                <img className="figure-img img-fluid" src="../src/assets/prj10/prj9.png" alt="Alerts dashboard" />
                <figcaption className="figure-caption">Alerts dashboard</figcaption>
              </figure>
              <figure className="col-9 mt-3 tc-project_content">
                <img className="figure-img img-fluid" src="../src/assets/prj10/prj8.png" alt="Alerts logs" />
                <figcaption className="figure-caption">Alerts logs</figcaption>
              </figure>
              <figure className="col-9 mt-3 tc-project_content">
                <img className="figure-img img-fluid" src="../src/assets/prj10/prj10.png" alt="Custom Alert configuration" />
          ...
          <div id="imgModal" className="modal fade" tabIndex="-1" role="dialog" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
              <div className="modal-content">
                <div className="modal-body">
                  <img src="" className="imagepreview"/>
                  <button type="button" className="tc-button_close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
              </div>
            </div>
          </div>
