export default {
  ...
  brandOwner: 'Harris Dinga',
  brandEmail: "hello@triggercell.com",
  ...
  <>
    ...
    <meta property="og:image" content="./src/assets/tc-brand.svg"/>
    <link rel="shortcut icon" type="image/x-icon" href="./src/assets/tc-logo-favicon.png" />
    {/* <!-- google analytics */}
